...
RUN wget -O /opt/vosk-model-vi.zip https://alphacephei.com/vosk/models/vosk-model-small-vi-0.3.zip && \
    unzip /opt/vosk-model-vi.zip -d /opt/vosk-model-vi && \
    mv /opt/vosk-model-vi/vosk-model-small-vi-0.3/* /opt/vosk-model-vi/ && \
    rmdir /opt/vosk-model-vi/vosk-model-small-vi-0.3
...
RUN pip install websockets vosk requests py3langid
